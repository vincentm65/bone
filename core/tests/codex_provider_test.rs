use bone_core::llm::provider::{ChatMessage, ChatRole, ImageData};
use bone_core::llm::providers::codex::{
    CodexRequest, build_codex_messages, build_instructions, codex_tools,
};
use bone_core::tools::ToolDefinition;
...
fn test_build_codex_messages_preserves_interleaved_order() {
    use bone_core::llm::provider::{OutputItem, ReasoningItem};
